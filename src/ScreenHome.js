...
function ScreenHome(props) {
  ...
  return (
    <div className="Login-page" >
      ...
      <p className="titleHome">Suivez toute l'actualité avec Morning News</p>
      ...
      <div className="contain-log">
          {/* SIGN-IN */}
              ...
              <div className="Sign">
                ...
                <p className="textwhite">Connexion</p>
                ...
                <Button onClick={() => handleSubmitSignin()}  style={{width:'80px'}} type="primary">Valider</Button>
          ...
          {/* SIGN-UP */}
              ...
              <div className="Sign">
                ...
                <p className="textwhite">Inscription</p>
                      
                <Input onChange={(e) => setSignUpUsername(e.target.value)} className="Login-input" placeholder="nom d'utilisateur" />
                ...
                <Button onClick={() => handleSubmitSignup()} style={{width:'80px'}} type="primary">Valider</Button>
